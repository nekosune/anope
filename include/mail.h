...
namespace Mail
{
	...
	extern CoreExport bool ValidateReddit(const Anope::string &email);
	...
	/* A email message being sent */
	class RedditMessage : public Thread
	{
	private:
		Anope::string mail_to;
		Anope::string subject;
	...
	public:
		...
		* @param message The actual message
		*/
		RedditMessage(const Anope::string &mailto, const Anope::string &subject, const Anope::string &message);
